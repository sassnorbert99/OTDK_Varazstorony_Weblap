...
<?php foreach($posts as $post) : ?>
  ...
  <li class="breadcrumb-item">Posztolva ekkor: <?php echo $post['created_at']; ?> a   <?php echo $post['name']; ?> témakörben.</li>
		...
		<br><br>
		<!--<p><a class="btn btn-default" href="<?php echo site_url('/posts/'.$post['slug']); ?>">Olvass tovább</a></p>-->
		</div>
	</div>
<?php endforeach; ?>
...
<?php      
		...
		$id=$this->session->userdata('user_id');
         ...
         $conn = mysqli_connect("89.40.126.232:8080","varazstorony","VarazsTorony_18","varazstorony");
